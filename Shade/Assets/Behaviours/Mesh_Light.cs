...
public class Mesh_Light : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        m_meshFilter.sharedMesh.vertices = new Vector3[m_meshVertexCount];
        m_meshFilter.sharedMesh.vertices[0] = Vector3.zero;
        m_meshFilter.sharedMesh.triangles = new int[m_meshVertexCount * 3];
    ...
    void BuildMesh()
    {
        ...
        for (int i = 0; i < m_meshFilter.sharedMesh.vertices.Length; i++)
        {
        ...
        m_meshFilter.sharedMesh.vertices = m_tempMeshVertices;
        m_meshFilter.sharedMesh.triangles = m_tempMeshTriangles;

        //Recalculate mesh bounds
        m_meshFilter.sharedMesh.RecalculateBounds();

        //Rebuild UVs
        m_meshFilter.sharedMesh.uv = BuildUVs(m_meshFilter.sharedMesh.vertices);
    }
